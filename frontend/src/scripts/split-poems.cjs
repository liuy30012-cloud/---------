...
const authorDynastyMap = {
  ...
  // 唐代作者最终补充 (从待审核列表)
  '梁氏琼': 'tang', '李希仲': 'tang', '韦安石': 'tang', '窦希玠': 'tang',
  '陆景初': 'tang', '郑南金': 'tang', '李咸': 'tang', '赵彦伯': 'tang',
  '于经野': 'tang', '辛替否': 'tang', '王景': 'tang', '毕干泰': 'tang',
  '曲瞻': 'tang', '樊忱': 'tang', '孙佺': 'tang', '李从远': 'tang',
  '周利用': 'tang', '张景源': 'tang', '李恒': 'tang', '张锡': 'tang',
  '解琬': 'tang', '源乾曜': 'tang', '李元纮': 'tang', '裴漼': 'tang',
  '刘升': 'tang', '萧嵩': 'tang', '韦抗': 'tang', '李暠': 'tang',
  '韦述': 'tang', '陆坚': 'tang', '程行谌': 'tang', '褚秀': 'tang',
  '裴光庭': 'tang', '宇文融': 'tang', '崔沔': 'tang', '崔尚': 'tang',
  '胡皓': 'tang', '李适之': 'tang', '房琯': 'tang', '李泌': 'tang',
  '张谔': 'tang', '刘庭琦': 'tang', '郑繇': 'tang', '许景先': 'tang',
  '王丘': 'tang', '苏晋': 'tang', '崔禹锡': 'tang', '张嘉贞': 'tang',
  '王光庭': 'tang', '徐知仁': 'tang', '席豫': 'tang', '韩思复': 'tang',
  '裴耀卿': 'tang', '宋鼎': 'tang', '崔颂': 'tang', '孙翃': 'tang',
  '徐仁友': 'tang', '苏绾': 'tang', '康庭芝': 'tang', '张宣明': 'tang',
  '卢崇道': 'tang', '包融': 'tang', '蔡隐丘': 'tang', '蔡希周': 'tang',
  '蔡希寂': 'tang', '张翚': 'tang', '周瑀': 'tang', '谈戭': 'tang',
  '殷遥': 'tang', '沈如筠': 'tang', '孙处玄': 'tang', '徐延寿': 'tang',
  '樊晃': 'tang', '李憕': 'tang', '李邕': 'tang', '王湾': 'tang',
  '史青': 'tang', '王泠然': 'tang', '贺朝': 'tang', '万齐融': 'tang',
  '邢巨': 'tang', '薛业': 'tang', '孙逖': 'tang', '崔珪': 'tang',
  '杨浚': 'tang', '袁瓘': 'tang', '李昂': 'tang', '厍狄履温': 'tang',
  '寇坦': 'tang', '李休烈': 'tang', '李林甫': 'tang', '杨炎': 'tang',
  '元载': 'tang', '陈希烈': 'tang', '张渐': 'tang', '宋昱': 'tang',
  '卢象': 'tang', '卢鸿一': 'tang', '徐安贞': 'tang', '崔翘': 'tang',
  '梁升卿': 'tang', '吴巩': 'tang', '陆海': 'tang', '裴士淹': 'tang',
  '李元操': 'tang', '陶岘': 'tang', '裴迪': 'tang', '崔兴宗': 'tang',
  '苑咸': 'tang', '丘为': 'tang', '赵骅': 'tang', '崔亘': 'tang',
  '蒋维翰': 'tang', '范朝': 'tang', '杨颜': 'tang', '王岳灵': 'tang',
  '周万': 'tang', '颜真卿': 'tang', '萧颖士': 'tang', '崔曙': 'tang',
  '张巡': 'tang', '张抃': 'tang', '闾丘晓': 'tang', '庾光先': 'tang',
  '韦丹': 'tang', '萧昕': 'tang', '杨志坚': 'tang', '孟彦深': 'tang',
  '刘湾': 'tang', '孙昌胤': 'tang', '乔琳': 'tang', '柳浑': 'tang',
  '张谓': 'tang', '沈宇': 'tang', '张鼎': 'tang', '杨谏': 'tang',
  '张万顷': 'tang', '沈颂': 'tang', '梁锽': 'tang', '杜俨': 'tang',
  '赵良器': 'tang', '黄麟': 'tang', '郭向': 'tang', '郭良': 'tang',
  '王乔': 'tang', '徐九臯': 'tang', '阎宽': 'tang', '李收': 'tang',
  '程弥纶': 'tang', '屈同仙': 'tang', '豆卢复': 'tang', '荆冬倩': 'tang',
  '梁洽': 'tang', '郑绍': 'tang', '朱斌': 'tang', '梁德裕': 'tang',
  '常非月': 'tang', '张良璞': 'tang', '孙欣': 'tang', '王羡门': 'tang',
  '芮挺章': 'tang', '楼颕': 'tang', '杨贲': 'tang', '李清': 'tang',
  '陈季': 'tang', '王邕': 'tang', '庄若讷': 'tang', '魏璀': 'tang',
  '王𩔪': 'tang', '窦冀': 'tang', '鲁收': 'tang', '朱逵': 'tang',
  '许瑶': 'tang',
