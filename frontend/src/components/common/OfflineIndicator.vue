  ...
  <Transition name="slide-down">
    <div v-if="!isOnline" class="offline-indicator">
      <div class="offline-content">
        ...
        <span class="offline-hint">部分功能受限</span>
      </div>
    </div>
  </Transition>
  ...
  <Transition name="fade">
    <div v-if="showOfflineNotice" class="offline-notice-overlay" @click="showOfflineNotice = false">
      <div class="offline-notice" @click.stop>
        ...
        <p class="notice-message">此操作需要网络连接才能完成。请检查您的网络设置后重试。</p>
        <button class="notice-button" @click="showOfflineNotice = false">知道了</button>
      </div>
    </div>
  </Transition>
</template>
